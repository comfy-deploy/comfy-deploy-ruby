...
module OpenApiSDK
  module Operations
    ...
    class GetRunResponseBody < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(created_at: ::String, ended_at: ::String, gpu: ::OpenApiSDK::Operations::GetRunGpu, gpu_event_id: ::String, id: ::String, is_realtime: T::Boolean, live_status: ::String, machine_id: ::String, machine_type: ::OpenApiSDK::Operations::MachineType, machine_version: ::String, modal_function_call_id: ::String, org_id: ::String, origin: ::OpenApiSDK::Operations::Origin, progress: ::Float, queued_at: ::String, started_at: ::String, status: ::OpenApiSDK::Operations::Status, updated_at: ::String, user_id: ::String, webhook: ::String, webhook_intermediate_status: T::Boolean, webhook_status: ::OpenApiSDK::Operations::WebhookStatus, workflow_id: ::String, workflow_inputs: ::OpenApiSDK::Operations::WorkflowInputs, workflow_version_id: ::String, outputs: T.nilable(T::Array[::OpenApiSDK::Operations::Outputs]), run_log: T.nilable(::OpenApiSDK::Operations::RunLog), workflow_api: T.nilable(::OpenApiSDK::Operations::GetRunWorkflowApi)).void }
      def initialize(created_at: nil, ended_at: nil, gpu: nil, gpu_event_id: nil, id: nil, is_realtime: nil, live_status: nil, machine_id: nil, machine_type: nil, machine_version: nil, modal_function_call_id: nil, org_id: nil, origin: nil, progress: nil, queued_at: nil, started_at: nil, status: nil, updated_at: nil, user_id: nil, webhook: nil, webhook_intermediate_status: nil, webhook_status: nil, workflow_id: nil, workflow_inputs: nil, workflow_version_id: nil, outputs: nil, run_log: nil, workflow_api: nil)
