...
module OpenApiSDK
  module Operations
    ...
    class PostGpuEventRequestBody < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(event_type: ::OpenApiSDK::Operations::EventType, gpu_provider: ::OpenApiSDK::Operations::GpuProvider, machine_id: ::String, timestamp: ::String, event_id: T.nilable(::String), gpu_type: T.nilable(::OpenApiSDK::Operations::GpuType), is_workspace: T.nilable(T::Boolean), org_id: T.nilable(::String), user_id: T.nilable(::String), ws_gpu_type: T.nilable(::OpenApiSDK::Operations::WsGpuType)).void }
      def initialize(event_type: nil, gpu_provider: nil, machine_id: nil, timestamp: nil, event_id: nil, gpu_type: nil, is_workspace: nil, org_id: nil, user_id: nil, ws_gpu_type: nil)
