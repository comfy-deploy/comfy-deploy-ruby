...
module OpenApiSDK
  module Operations
    ...
    class GetV1MachinesResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :four_hundred_application_json_object, T.nilable(::OpenApiSDK::Operations::GetV1MachinesMachinesResponseBody)
      # Invalid or expired token
      field :four_hundred_and_one_text_plain_res, T.nilable(::String)


      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, two_hundred_application_json_object: T.nilable(::OpenApiSDK::Operations::GetV1MachinesResponseBody), four_hundred_application_json_object: T.nilable(::OpenApiSDK::Operations::GetV1MachinesMachinesResponseBody), four_hundred_and_one_text_plain_res: T.nilable(::String)).void }
