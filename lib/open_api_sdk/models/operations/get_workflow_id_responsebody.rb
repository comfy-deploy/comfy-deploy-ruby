...
module OpenApiSDK
  module Operations
    ...
    class GetWorkflowIdResponseBody < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(comment: ::String, created_at: ::String, id: ::String, updated_at: ::String, user_id: ::String, version: ::Float, workflow_id: ::String, dependencies: T.nilable(::Object), snapshot: T.nilable(::Object), workflow: T.nilable(::Object), workflow_api: T.nilable(::Object)).void }
      def initialize(comment: nil, created_at: nil, id: nil, updated_at: nil, user_id: nil, version: nil, workflow_id: nil, dependencies: nil, snapshot: nil, workflow: nil, workflow_api: nil)
        @comment = comment
