...
module OpenApiSDK
  module Operations
    ...
    class ResponseBody < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :class_type, ::OpenApiSDK::Operations::ClassType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('class_type'), 'decoder': Utils.enum_from_string(::OpenApiSDK::Operations::ClassType, false) } }
      ...
      sig { params(class_type: ::OpenApiSDK::Operations::ClassType, default_value: ::Object, input_id: ::String, description: T.nilable(::String), display_name: T.nilable(::String), enum_values: T.nilable(T::Array[::String]), max_value: T.nilable(::Float), min_value: T.nilable(::Float)).void }
