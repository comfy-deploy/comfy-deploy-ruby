...
module OpenApiSDK
  ...
  class ComfyDeploy
    ...
    attr_accessor :run, :files, :websocket, :comfyui, :workflows, :deployment, :machine
    ...
    def init_sdks
      ...
      @websocket = Websocket.new(@sdk_configuration)
      @comfyui = Comfyui.new(@sdk_configuration)
      @workflows = Workflows.new(@sdk_configuration)
      @deployment = Deployment.new(@sdk_configuration)
      @machine = Machine.new(@sdk_configuration)
    end
  end
end
