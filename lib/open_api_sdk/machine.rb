  ...
  class Machine
    ...
    def post_gpu_event(request)
      ...
      if r.status == 200
        ...
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::PostGpuEventMachineResponseBody)
    ...
    sig { params(request: T.nilable(::OpenApiSDK::Operations::PostEndGpuEventRequestBody)).returns(::OpenApiSDK::Operations::PostEndGpuEventResponse) }
    def post_end_gpu_event(request)
      # post_end_gpu_event - Register a machine event end
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = "#{base_url}/end_gpu_event"
      headers = {}
      req_content_type, data, form = Utils.serialize_request_body(request, :request, :json)
      headers['content-type'] = req_content_type
      headers['Accept'] = 'application/json;q=1, text/plain;q=0'
      ...
      res = ::OpenApiSDK::Operations::PostEndGpuEventResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::PostEndGpuEventResponseBody)
          res.two_hundred_application_json_object = out
        end
      elsif r.status == 401
        res.four_hundred_and_one_text_plain_res = r.env.response_body if Utils.match_content_type(content_type, 'text/plain')
        ...
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::PostEndGpuEventMachineResponseBody)
          res.five_hundred_application_json_object = out
        end
      end
    ...
    sig { params(machine_id: ::String, status: ::OpenApiSDK::Operations::Status, limit: T.nilable(::Float)).returns(::OpenApiSDK::Operations::GetMachineMachineIdEventsResponse) }
    def list_events(machine_id, status, limit = nil)
      # list_events - Get recent gpu events
      request = ::OpenApiSDK::Operations::GetMachineMachineIdEventsRequest.new(
      ...
      url = Utils.generate_url(
        ::OpenApiSDK::Operations::GetMachineMachineIdEventsRequest,
        base_url,
        '/machine/{machine_id}/events',
        request
      )
      headers = {}
      query_params = Utils.get_query_params(::OpenApiSDK::Operations::GetMachineMachineIdEventsRequest, request)
      headers['Accept'] = 'application/json;q=1, text/plain;q=0'
      headers['user-agent'] = @sdk_configuration.user_agent
      ...
      res = ::OpenApiSDK::Operations::GetMachineMachineIdEventsResponse.new(
        status_code: r.status, content_type: content_type, raw_response: r
      )
      if r.status == 200
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, T::Array[::OpenApiSDK::Operations::GetMachineMachineIdEventsMachineResponseBody])
        ...
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::GetMachineMachineIdEventsResponseBody)
          res.object = out
        end
      end
    ...
    def post_v1_machines(request)
      ...
      if r.status == 200
        ...
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::PostV1MachinesMachineResponseBody)
    ...
    def get_v1_machines(page = nil, page_size = nil, fields_ = nil)
      ...
      if r.status == 200
        ...
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::GetV1MachinesMachineResponseBody)
          res.four_hundred_application_json_object = out
        end
      elsif r.status == 401
        res.four_hundred_and_one_text_plain_res = r.env.response_body if Utils.match_content_type(content_type, 'text/plain')
    ...
    def get_v1_machines_machine_id_(machine_id, ext_urls = nil)
      ...
      if r.status == 200
        ...
        if Utils.match_content_type(content_type, 'application/json')
          out = Utils.unmarshal_complex(r.env.response_body, ::OpenApiSDK::Operations::GetV1MachinesMachineIdMachineResponseBody)
          res.four_hundred_application_json_object = out
        end
      elsif r.status == 401
        res.four_hundred_and_one_text_plain_res = r.env.response_body if Utils.match_content_type(content_type, 'text/plain')
